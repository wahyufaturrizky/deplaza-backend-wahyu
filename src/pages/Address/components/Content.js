...
const DataTable = (props) => {
    ...
    useEffect(() => {
        if (search) {
            axiosConfig.get(`${URL_STRING}?limit=10&keyword=${debouncedSearch}`)
                .then(res => {
                ...
                <div className="container-fluid">
                    <div className="row mb-2">
                        <div className="col-sm-6" style={{ flexDirection: 'row', display: "flex", justifyContent: 'space-around', alignItems: 'center' }}>
                            ...
                            <button type="button" class="btn btn-block btn-success btn-sm" style={{ width: 130, height: 40, marginTop: 7 }} data-toggle="modal" data-target="#modal-lg">Tambah Alamat</button>
                                        ...
                                        <tbody>
                                            {loading === true ? <Spinner /> : categoriesData.map((comment, i) => (
                                                <tr>
                                                    ...
                                                    <td>{comment.phone}</td>
                                                    <td>{comment.address}, Kota: {comment.city_name}, Provinsi: {comment.prov_name}, Kode Pos: {comment.zip_code} </td>
                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="card-body">
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="exampleInputEmail1" placeholder="Nama" onChange={(e) => {
                                        setName(e.target.value)
                                    }} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Label</label>
                                    <input type="text" className="form-control" id="exampleInputEmail1" placeholder="rumah" onChange={(e) => {
                                        setLabel(e.target.value)
                                    }} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">No Telepon</label>
                                    <input type="text" className="form-control" id="exampleInputEmail1" placeholder="0899999999" onChange={(e) => {
                                        setPhone(e.target.value)
                                    }} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Alamat</label>
                                    <input type="text" className="form-control" id="exampleInputEmail1" placeholder="Alamat" onChange={(e) => {
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="exampleInputEmail1" placeholder="1542" onChange={(e) => {
                        ...
                        <div className="modal-footer justify-content-between">
                            ...
                            <button type="button" className="btn btn-primary" onClick={handleAddCategory}>Tambah Alamat</button>
                        </div>
                    </div>
                    {/* /.modal-content */}
                </div>
            ...
            <div className="modal fade" id="modal-edit">
                <div className="modal-dialog modal-edit">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer justify-content-between">
                            <button type="button" className="btn btn-default" onClick={hideModal}>Close</button>
                            <button type="button" className="btn btn-primary" onClick={changeData}>Rubah Alamat</button>
                        </div>
                    </div>
                    {/* /.modal-content */}
                </div>
