...
const DataTable = (props) => {
    ...
    const handleAddCategory = (e) => {
        ...
        axiosConfig.post(URL_POST, formData)
            .then(res => {
                ...
                // tanpa di reload
                getData();
                toastr.success('Berhasil menambahkan Bank')
                hideModal()
            }).catch(error => toastr.error(error))
    }
    ...
    const changeData = (e) => {
        ...
        axiosConfig.post(`${URL_POST}/${id}`, formData)
            .then(res => {
                toastr.success('Berhasil merubah Bank')
                getData();
        ...
        <div className="content-wrapper">
                ...
                <div className="container-fluid">
                    <div className="row mb-2">
                        <div className="col-sm-6" style={{ flexDirection: 'row', display: "flex", justifyContent: 'space-around', alignItems: 'center' }}>
                            <h1 className="m-0 text-dark">Menu Bank</h1>
                            <button type="button" class="btn btn-block btn-success btn-sm" style={{ width: 130, height: 40, marginTop: 7 }} data-toggle="modal" data-target="#modal-lg">Tambah Bank</button>
                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">Tambah Bank</h4>
                        ...
                        <div className="modal-body">
                            <div className="card-body">
                                ...
                                <div className="form-group">
                                    <label htmlFor="exampleInputFile">Gambar Bank</label>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="exampleInputEmail1" placeholder="Nama Bank" onChange={(e) => {
                        ...
                        <div className="modal-footer justify-content-between">
                            ...
                            <button type="button" className="btn btn-primary" onClick={handleAddCategory}>Tambah Bank</button>
                        </div>
                    </div>
                    {/* /.modal-content */}
                </div>
            ...
            <div className="modal fade" id="modal-detail">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">Detail Bank</h4>
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div className="modal-body">
                            <div className="card-body">
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Gambar Bank</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Judul Bank</label>
                                    <h4>{detail.name}</h4>
                                </div>
                                <div className="form-group">
            ...
            <div className="modal fade" id="modal-edit">
                <div className="modal-dialog modal-edit">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">Ubah Bank</h4>
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
