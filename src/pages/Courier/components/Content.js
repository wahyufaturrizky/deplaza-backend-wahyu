...
const URL_STRING = '/courier';
const URL_POST = '/courier'
...
const DataTable = (props) => {
    ...
    const handleAddCategory = (e) => {
        ...
        axiosConfig.post(URL_POST, formData)
            .then(res => {
                ...
                // tanpa di reload
                getData();
                toastr.success('Berhasil menambahkan kurir')
                hideModal()
            }).catch(error => toastr.error(error))
    }
    ...
    const changeData = (e) => {
        ...
        axiosConfig.post(`${URL_POST}/${id}`, formData)
            .then(res => {
                toastr.success('Berhasil merubah kurir')
                getData();
        ...
        <div className="content-wrapper">
                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">Tambah Kurir</h4>
                        ...
                        <div className="modal-body">
                            <div className="card-body">
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Judul Kurir</label>
                                    <input type="text" className="form-control" id="exampleInputEmail1" placeholder="Judul Kurir" onChange={(e) => {
                                        setTitle(e.target.value)
                                    }} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Deskripsi Kurir</label>
                                    <input type="text" className="form-control" id="exampleInputEmail1" placeholder="Deskripsi Kurir" onChange={(e) => {
                                        setDescription(e.target.value)
                                    }} />
                                </div>
                                {urls.length > 0 && displayUploadedFiles(urls)}
                                <div className="form-group">
                                    <label htmlFor="exampleInputFile">Gambar Kurir</label>
                        ...
                        <div className="modal-footer justify-content-between">
                            ...
                            <button type="button" className="btn btn-primary" onClick={handleAddCategory}>Tambah Kurir</button>
                        </div>
                    </div>
                    {/* /.modal-content */}
                </div>
            ...
            <div className="modal fade" id="modal-detail">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">Detail Kurir</h4>
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div className="modal-body">
                            <div className="card-body">
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Gambar Kurir</label>
                                ...
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Nama Kurir</label>
                                    <h4>{detail.name}</h4>
                                </div>
                                <div className="form-group">
            ...
            <div className="modal fade" id="modal-edit">
                <div className="modal-dialog modal-edit">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">Ubah Kurir</h4>
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
