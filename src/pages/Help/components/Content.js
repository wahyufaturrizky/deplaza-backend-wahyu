...
const DataTable = (props) => {
  ...
  const getHelpdesk = () => {
    setLoading(true);
    axiosConfig
      .get(`${URL_STRING}?order_direction=desc`)
      .then((json) => {
  ...
  const helpdeskData = useMemo(() => {
    ...
    if (search) {
      computedHelpdesk = computedHelpdesk.filter((data) =>
                      ...
                      {loading === true ? (
                        ...
                        helpdeskData.map((helpdesk, i) => (
                          <tr>
                            ...
                            <td>
                              {getData
                                .filter((x) => x.value === helpdesk.user_id)
                                .map((x) => x.label)}
                            </td>
                            {helpdesk.problem.length > 100 && show === false ? (
                              ...
                              <div>
                                ...
                                {helpdesk.problem.length < 100 ? null : (
                            ...
                            <td>
                              {helpdesk.status === 0 ? "Proses" : "Selesai"}
                            </td>
                            <div
                              style={{
                                flexDirection: "row",
                            ...
                            >
                              <button
                                ...
                                onClick={() => showModalEdit(helpdesk.id)}
                              >
                                Ubah
                              </button>
                              <button
                                ...
                                onClick={() => deleteData(helpdesk.id)}
                              >
                                Hapus
                              </button>
                            </div>
