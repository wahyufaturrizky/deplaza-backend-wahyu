...
const URL_STRING = "/withdrawal?order_direction=desc";
      ...
      <div className="content-header">
        <div className="container-fluid">
          <div className="row mb-2">
            ...
            >
              <h1 className="m-0 text-dark">Penarikan Saldo</h1>
              <button
                type="button"
            ...
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                ...
                <li className="breadcrumb-item active">Penarikan Saldo</li>
              </ol>
            </div>
            {/* /.col */}
          </div>
                      ...
                      {loading === true ? (
                        ...
                        productsData.map((product, i) => {
                          const getBank =
                            ...
                            bank.find(
                              (o) =>
                                o.id === product.account &&
                                product.account.bank_id
                            );
                          return (
                            <tr>
                              ...
                              <td>
                                {getBank && getBank.name}{" "}
                                {product.account && product.account.number} a.n{" "}
